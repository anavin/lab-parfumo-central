...
const CAP_P1 = 16;        // page 1 (full header), not the last page
const CAP_PN = 20;        // continuation page (compact header), not the last page
const FOOTER_ROWS = 10;   // rows-equivalent space the summary + signatures need on the last page
