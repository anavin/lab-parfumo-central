...
import { pendingSubmissions, recentlyApprovedSubmissions, attachmentsForRefs } from "@/lib/queries";
...
export default async function ReviewPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1000px] mx-auto">
      ...
      <ReviewQueue rows={rows} approved={approved} attachments={attachments} />
    </div>
  );
}
